...
def Dijkstra(graph, modifiedGraph, src, modifyWeights):
	...
	for vertex in range(num_vertices):
		print ('Vertex ' + str(vertex) + ': ' + str(dist[vertex] + modifyWeights[vertex] - modifyWeights[src] ))
...
def JohnsonAlgorithm(graph):
	...
	for src in range(len(graph)):
		...
		Dijkstra(graph, modifiedGraph, src, modifyWeights)
